...
import { useUser } from "@/hooks/deepsite/useUser";
import { usePathname, useRouter } from "next/navigation";
import { useMount } from "react-use";
import { UserContext } from "@/components/deepsite-v2/contexts/user-context";
import { User } from "@/lib/deepsite/deepsite-v2-types";
import { toast } from "sonner";
import { useBroadcastChannel } from "@/lib/deepsite/useBroadcastChannel";
...
export default function AppContext({
  ...
  const { user, logout, loading, errCode } = useUser();
